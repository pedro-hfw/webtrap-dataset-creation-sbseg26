...
parser = argparse.ArgumentParser(description = "Gerador de Tráfego de Busca [MALICIOSO]")
...
OUTPUT_CSV   = str(BASE_DIR / "generated_requests" / "ANOMALOUS_Search_GETS.csv")
...
def generate_query():
    ...
    if random.random():
        base.append(f"search={malicious_payload}")
