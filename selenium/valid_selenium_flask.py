...
parser = argparse.ArgumentParser(description = "Selenium Navegador com Flask")
...
OUTPUT_CSV   = str(ROOT_DIR / "generated_requests" / "VALID_Selenium_POSTS.csv")
...
def fill_register(driver, wait):
    ...
    driver.find_element(By.ID, "password_confirm").send_keys(rand(PASSWORDS))
...
def fill_search(driver, wait):
    ...
    driver.find_element(By.ID, "brand").send_keys(rand(BRAND))
...
def fill_contact(driver, wait):
    ...
    driver.find_element(By.ID, "message").send_keys(rand(MESSAGES))
...
def fill_profile(driver, wait):
    ...
    driver.find_element(By.ID, "bio").send_keys(rand(BIOS))
...
def fill_checkout(driver, wait):
    ...
    driver.find_element(By.ID, "recipient_name").send_keys(rand(NAMES))
    driver.find_element(By.ID, "cep").clear()
    driver.find_element(By.ID, "cep").send_keys(rand(CEPS))
    driver.find_element(By.ID, "street").clear()
    driver.find_element(By.ID, "street").send_keys(rand(STREET))
...
def fill_comment(driver, wait):
    ...
    driver.find_element(By.ID, "body").send_keys(rand(COMMENTS))
...
FORMS = [
    ...
    ("/products", "form-products", fill_products),
]
